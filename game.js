...
export class Game {
    ...
    async setupMediaPipe() {
        ...
        try {
            ...
            const { Hands } = await import('https://cdn.jsdelivr.net/npm/@mediapipe/hands@0.8.1675469240/hands.js');
            ...
            this.hands = new Hands({
                locateFile: (file) => {
                    return `https://cdn.jsdelivr.net/npm/@mediapipe/hands@0.8.1675469240/${file}`;
                }
            });
